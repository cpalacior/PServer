...
class ProductServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getResource = channel.unary_unary(
                '/ProductService/getResource',
                request_serializer=Service__pb2.Resource.SerializeToString,
...
def add_ProductServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'getResource': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=Service__pb2.Resource.FromString,
...
class ProductService(object):
    ...
    def getResource(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ProductService/getResource',
            Service__pb2.Resource.SerializeToString,
